...
<body >
	<form  method="post" >
    <table >
        <tr> <th id="h" colspan = "2"  > Login </th> </tr>
     ...
     <tr> <td  colspan="2" align="center"> <a href="regis.jsp" target="_blank">New User? Click to Register</a> </td> </tr>   
    ...
    res=Registrations.login(user_id,pswd);
      ...
      window.location.assign("view_response.jsp");
   </script>
    	  <% 
      }
